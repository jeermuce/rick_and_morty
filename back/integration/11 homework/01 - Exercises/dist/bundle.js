(() => {
  var r = {
      791: (r, t, e) => {
        ...
        e.r(t),
          e.d(t, {
            ...
            applyMiddleware: () => E,
            bindActionCreators: () => b,
            combineReducers: () => s,
            compose: () => v,
            createStore: () => y,
            legacy_createStore: () => l,
          });
        var f =
        ...
        function y(r, t, e) {
          ...
          if (
            ...
            if ("function" != typeof e) throw new Error(u(1));
            return e(y)(r, t);
          }
          if ("function" != typeof r) throw new Error(u(2));
          var o = r,
            i = t,
            c = [],
            a = c,
          ...
          function b(r) {
            if ("function" != typeof r) throw new Error(u(4));
          ...
          function v(r) {
            if (
              ...
              throw new Error(u(7));
            if (void 0 === r.type) throw new Error(u(8));
            ...
            for (var t = (c = a), e = 0; e < t.length; e++) (0, t[e])();
            return r;
          }
          return (
            v({ type: p.INIT }),
            ((n = {
              ...
              replaceReducer: function (r) {
                if ("function" != typeof r) throw new Error(u(10));
                (o = r), v({ type: p.REPLACE });
              },
            })[f] = function () {
              var r,
                t = b;
          ...
          try {
            !(function (r) {
              Object.keys(r).forEach(function (t) {
                var e = r[t];
                if (void 0 === e(void 0, { type: p.INIT }))
                  throw new Error(u(12));
                if (void 0 === e(void 0, { type: p.PROBE_UNKNOWN_ACTION() }))
          ...
          return function (r, t) {
            ...
            for (var n = !1, o = {}, f = 0; f < c.length; f++) {
              var a = c[f],
                ...
                y = r[a],
                l = p(y, t);
              if (void 0 === l) throw (t && t.type, new Error(u(14)));
              (o[a] = l), (n = n || l !== y);
            }
            return (n = n || c.length !== Object.keys(r).length) ? o : r;
          };
        }
        function d(r, t) {
          return function () {
        ...
        function b(r, t) {
          if ("function" == typeof r) return d(r, t);
          if ("object" != typeof r || null === r) throw new Error(u(16));
          var e = {};
          for (var n in r) {
            var o = r[n];
            "function" == typeof o && (e[n] = d(o, t));
          }
          return e;
        }
        function v() {
      ...
      883: (r) => {
        r.exports = { INCREMENTO: "INCREMENTO", DECREMENTO: "DECREMENTO" };
      },
      518: (r, t, e) => {
        const { INCREMENTO: n, DECREMENTO: o } = e(883);
        r.exports = {
          incremento: () => ({ type: n }),
          decremento: () => ({ type: o }),
        };
      ...
      616: (r, t, e) => {
        const { INCREMENTO: n, DECREMENTO: o } = e(883),
          i = { contador: 0 };
        r.exports = function (r = i, t) {
          switch (t.type) {
            case n:
              return { ...r, contador: r.contador + 1 };
            case o:
              return { ...r, contador: r.contador - 1 };
            default:
              return { ...r };
  ...
  (e.d = (r, t) => {
    ...
    (() => {
      const { createStore: r } = e(791),
        t = e(616),
        { incremento: n, decremento: o } = e(518);
      let i = r(t),
        c = document.getElementById("valor");
      function u() {
        const r = i.getState().contador;
        c.innerHTML = r;
      }
      u(),
        i.subscribe(u),
